...
void AnimationManager::EditAnimation()
{
	...
	while (RUNNING)
	{
		...
		std::cout << "MENU" << std::endl <<
			"1. Insert a Frame at front" << std::endl <<
			"2. Delete first Frame" << std::endl <<
...
Author: Brady McIntosh
**********************************************************/
istream& operator>>(istream& in, AnimationManager& animManager)
{
	char usr_c1[65];	/* user input char buffer #1 */
...
Author: Brady McIntosh
**********************************************************/
ostream& operator<<(ostream& out, AnimationManager& animManager)
{
