...
{
	int eob_value;	/* the value of the EOB bit in the "flags" member */
...
int b_print(Buffer* const pBD, char nl)
{
	...
	int cont;			/* whether or not loop will continue */
